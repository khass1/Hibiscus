...
toc: true
cta:
  title: "Which of these models is your project?"
  text: "Tell us where the project stands — from there we can estimate the full schedule."
  label: "Start a conversation"
  whatsapp: "Hello! I read the development models page and would like to understand which one applies to my project."
---

<!-- Translation of modelos-de-desenvolvimento.md. Any change to commercial or
     legal claims must be mirrored across all three languages. -->
...
<div class="destaque">
<p><strong>We do not work from a fixed catalogue.</strong> There is no list of ready-made formulas with a unit price to choose from. Every project goes through the definition of formula, packaging and volume before it becomes a quote.</p>
</div>

{{< cta-inline
     title="Recognised your case among the three?"
     text="If it is still not clear, we can settle that in conversation too — it usually takes a few minutes."
     label="Talk about my project"
     whatsapp="Hello! I read the three development models and would like to understand which one applies to my project." >}}
...
1. Formula development and samples
2. Packaging sourcing and compatibility testing
3. Brand identity and label artwork
4. Final quote
5. Production and filling
